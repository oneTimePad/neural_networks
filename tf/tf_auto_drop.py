...
"""
stacked autoencoder with tied weights and drop out based off of
...
with tf.name_scope('network'):
    h1,w1,b1 = fc_layer(X_drop,n_hidden1,'first_stack')
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epoch):
        ...
        for iteration in range(n_batches):
            ...
            sess.run(train_op1,feed_dict={X:X_batch,training:True})
