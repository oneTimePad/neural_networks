...
def fc_layer(x,n_hidden,scope,activation=True,reuse=False,transpose=False,layer_name='hidden'):
...
with tf.name_scope('network'):
    h1,w1 = fc_layer(X,n_hidden1,'first_stack')
    h2,w2 = fc_layer(h1,n_hidden2,'second_stack')
    h3,_ = fc_layer(h2,n_hidden1,'second_stack',transpose=True,reuse=True)
    out,_ = fc_layer(h3,n_inputs,'first_stack',activation=False,transpose=True,reuse=True,layer_name='out')

aux1,_ = fc_layer(h1,n_inputs,'first_stack',activation=False,reuse=True,transpose=True,layer_name='aux1_out')
